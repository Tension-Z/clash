...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/Tension-Z/clash/constant.Version=$(VERSION)" \
		-X "github.com/Tension-Z/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
